    ...
    <div class="footer-content container">
        <div class="row">
            <div class="footer-section about col-md-4 col-12">
                ...
                <div class="socials">
                    <a href="https://vk.com/"><i class="fa-brands fa-vk"></i></a> <!--VK-->
                    <a href="https://github.com/Light278/"><i class="fa-brands fa-github"></i></a> <!--GitHub-->
        ...
        <div class="footer-bottom">
            &copy; osmanov.com | Designed by Osman Ramazanov <!--Копирайтинг-->
        </div>
    </div>
</div>